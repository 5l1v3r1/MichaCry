...
if [[ "$user" != "root" ]]
then
	echo -e "\e[1m\e[31mNOTE: You don't have admin privileges, execute the script as root.\e[0m\e[0m"
	exit 0
fi
...
echo -e """\e[1m\e[31m~
     ...
     |          							                                |
     |	#Coded by Wreck-it Kenny | @wreckitkenny | https://wreckitkenny.net |
      ======================================================================
\e[0m\e[0m"""
espeak "Hello guys! This is MichaCry. Select one of the following options. Thank you"
